                    ...
                    <div class="collapsible-body">
                        <div class="row">
                            <?= $this->Gus->create(); ?>
                                                        ...
                                                        <?= $this->Gus->control('pais_id', ['div' => 'col s2 m1 l1', 'label' => 'Pais Id']); ?>
    ...
    <table class="responsive-table index highlight">
        ...
        <?php foreach ($estados as $estado): ?>
            <tr>
                ...
                <td><input type="checkbox" id="check<?= $estado->id ?>" class="filled-in" name="data[ids][<?= $estado->id ?>]" value="<?= $estado->id ?>" /><label for="check<?= $estado->id ?>">&nbsp;</label></td>
                <td><?= h($estado->nome) ?></td>
